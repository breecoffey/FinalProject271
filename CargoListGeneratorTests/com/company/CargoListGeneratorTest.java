...
public class CargoListGeneratorTest {
     ...
     * @throws InvalidInputException if the item has 0 weight or 0 value
     */

    @Test
    public void calculateItemsLeftBehind() throws InvalidInputException {
     ...
     * @throws InvalidInputException if item has weight or value of 0
     */
    ...
    @Test
    public void generateList() throws InvalidInputException {
        CargoItemList itemList = new CargoItemList();
        ...
        assertEquals(expectedString, testGenerator2.generateList(anotherItemList, 50));
    }
